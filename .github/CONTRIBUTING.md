...
- [Search our issue
  tracker](https://github.com/manifoldco/manifold-laravel-demo/issues/search&type=issues)
  for your problem, someone may have already reported it

# Opening a Pull Request

To contribute, [fork](https://help.github.com/articles/fork-a-repo/)
`manifold-laravel-demo`, commit your changes, and [open a pull
...
Manifold-laravel-demo is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/manifold-laravel-demo), either for an
